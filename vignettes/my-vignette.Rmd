...
Q_kmean <- mr_cluster_heterogeneity(cluster = kmean)
Q_hclust <- mr_cluster_heterogeneity(cluster = hclust)
Q_pv <- mr_cluster_heterogeneity(cluster = pv)
Q_pam <- mr_cluster_heterogeneity(cluster = pam)
