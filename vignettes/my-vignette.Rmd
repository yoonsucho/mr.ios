...
Q_kmean <- mr_cluster_heterogeneity(cluster = kmean, weights = 3)
Q_hclust <- mr_cluster_heterogeneity(cluster = hclust, weights = 3)
Q_pv <- mr_cluster_heterogeneity(cluster = pv, weights = 3)
Q_pam <- mr_cluster_heterogeneity(cluster = pam, weights = 3)
